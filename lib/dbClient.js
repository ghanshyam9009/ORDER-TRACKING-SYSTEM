...
async function closePosition(
  ...
  console.log(orderPayload);
    ...
    console.log("💸 addes entry in funds tracker for realized pnl:", realizedPnL);
  }
  ...
  if (contributionAmount > 0) {
    ...
    console.log("💸 addes entry in funds tracker for contribution amount:", contributionAmount);
  }
  ...
  console.log("💸 added entry in funds tracker for brokrage fees:", BROKERAGE_FEE);
}
